    ...
    public class MookRecevied : IReceived
    {
            ...
            int? TheSection)
        {
            ...
            switch (mailNumType)
            {
                ...
                case 0:
                    if (role_id.Any(x => x.RoleId == 15 && x.RoleId == 16 && x.RoleId == 17))
                    {
           ...
           Measure_filter, Department_filter, Classfication, mail_state, TheSection,  genral_incoming_num);
                ...
                case 1:
                    if (role_id.Any(x => (x.RoleId == 15 && x.RoleId == 16 && x.RoleId == 17) || x.RoleId == 15))
                    {
                        mail_type = 1;
           ...
           Measure_filter, Department_filter, mail_state, Classfication, genral_incoming_num );
                    ...
                    break;
                case 2:
                    if (role_id.Any(x => (x.RoleId == 15 && x.RoleId == 16 && x.RoleId == 17) || x.RoleId == 17))
                    {
                        mail_type = 2;
           ...
           Measure_filter, Department_filter, Classfication,  mail_state,  TheSection, genral_incoming_num );
                ...
                case 3:
                    if (role_id.Any(x => (x.RoleId == 15 && x.RoleId == 16 && x.RoleId == 17) || x.RoleId == 16))
                    {
                        mail_type = 3;
