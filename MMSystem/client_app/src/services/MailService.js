...
export default {
    ...
    Send_resend(mailId, userId) {
        return axios.put(`/api/Resend/SendResendMail?mail_id=${mailId}&userId=${userId}`)
    ...
    sent(id, mailType, mangment_id, date_from, date_to, by_date_of_reply, mail_id, general_incoming_number, summary, department_id, side_id, measure_id, classification_id, mail_case_id,s_number, page_num, page_size) {
