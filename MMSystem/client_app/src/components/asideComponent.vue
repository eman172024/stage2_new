        ...
        <div :class="toggle_nav ? 'w-64' : 'w-20'" class=" flex flex-col">
            ...
            <div class="border-l border-gray-200 z-10 pt-5 pb-4 flex flex-col flex-grow overflow-y-auto">
                ...
                <div class="flex-grow mt-5 flex flex-col">
                    <nav class="flex-1 bg-gray-50 flex flex-col justify-between">
                        ...
                        <div class="px-2 space-y-1">
                            ...
                            <router-link title="لوحة التحكم" :to="{ name: 'dashboard' }" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group rounded-md py-2 px-2 flex items-center justify-center text-sm font-medium">
              ...
              >
                ...
                "
              >
               <svg  class="text-gray-400 group-hover:text-gray-500 h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                 
                
               
                <span v-if="toggle_nav"> المحفوظات </span>
              </router-link>
