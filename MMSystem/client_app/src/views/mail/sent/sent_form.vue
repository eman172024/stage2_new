<template>
  <div class="">
          ...
          <main class="flex-1 relative focus:outline-none py-6">
            <div class="grid grid-cols-7 gap-6">
              <section class="col-span-5 flex justify-between items-stretch">
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="flex justify-between items-center">
                      ...
                      <div v-if="roles.includes('e')" class="flex items-center mx-4">
                        <input v-model="mailType" id="internal_export" type="radio" name="type" class="h-4 w-4"
                          value="2" />
                      ...
                      <div v-if="roles.includes('d')" class="flex items-center">
                        <input v-model="mailType" id="external_incoming" type="radio" name="type" class="h-4 w-4"
                          value="3" />
                ...
                <div v-if="my_department_id == 21 || my_department_id == 22" class="
                      grid grid-cols-7
                      gap-3
                      ...
                      <div class="flex items-center">
                        <div v-if="my_department_id == 21" class="w-full flex items-center">
                          <div class="flex items-center w-32">
                            <input v-model="office_type" id="chief" type="radio" name="office_type" class="h-4 w-4"
                              value="1" />
                          ...
                          <div class="flex items-center w-32">
                            <input v-model="office_type" id="proxy" type="radio" name="office_type" class="h-4 w-4"
                              value="2" />
              ...
              <section class="col-span-2">
                <div class="
                  ...
                  <span class="mr-4 underline font-bold text-2xl flex items-center">
                    <input type="number" min="1" max="5000" @keypress.enter="mail_search()"
                      class="w-24 px-1 rounded-md focus:outline-none" v-model="mail_Number" />
                    <div class="
                          w-16
                          px-1
                          rounded-md
                    ...
                    <input type="number" @keypress.enter="mail_search()" class="w-20 px-1 rounded-md focus:outline-none"
                      v-model="mail_year" />
                  </span>
                </div>
              </section>
            ...
            <div class="mt-6 space-y-6 relative">
              ...
              <div class="grid grid-cols-7 gap-6">
                <section class="col-span-5 flex justify-between items-stretch">
                  <section class="
                    ...
                    <div class="sm:col-span-6">
                      <label for="summary" class="block text-sm font-semibold text-gray-800">
                        الملخص
                      </label>
                      <!-- v-if="mail_flag <= 2 || roles.includes('7')" -->
                      <textarea v-model="summary" id="summary" rows="3" class="
                            block
                            mt-2
                            w-full
                            text-sm
                    ...
                    <div class="sm:col-span-3">
                      <label for="classification" class="block text-sm font-semibold text-gray-800">
                        التصنيف
                      </label>
                      <!-- v-if="mail_flag <= 2 || roles.includes('7')" -->
                      <select v-model="classification" id="classification" class="
                            block
                            mt-2
                            w-full
                            h-10
                        ...
                        <option v-for="classification in classifications" :key="classification.id"
                    ...
                    <div class="sm:col-span-3">
                      ...
                      <!-- v-if="mail_flag <= 2 || roles.includes('7')" -->
                      <input v-model="releaseDate" min="2000-01-01" max="2040-12-30" type="date" id="date" class="
                            block
                            mt-2
                            w-full
                            rounded-md
                    ...
                    <div class="sm:col-span-2">
                      <label for="general_incoming_number" class="block text-sm font-semibold text-gray-800">
                        رقم الوارد العام
                      </label>
                      <!-- v-if="mail_flag <= 2 || roles.includes('7')" -->
                      <input v-model="general_incoming_number" type="text" min="1" max="50000"
                    ...
                    <div class="sm:col-span-2">
                      <label for="year" class="block text-sm font-semibold text-gray-800">
                        السنة
                      </label>
                      <!-- v-if="mail_flag <= 2 || roles.includes('7')" -->
                      <input type="number" placeholder="YYYY" min="2011" max="2100" v-model="genaral_inbox_year" id="year"
                        class="
                            block
                            mt-2
                            w-full
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <!-- v-if="mail_flag <= 2 || roles.includes('7')" -->
                      <input type="text" v-model="old_mail_number" id="old_mail_number" class="
                            block
                            mt-2
                            w-full
                            rounded-md
                  ...
                  <section class="
                      ...
                      ">
                    <div class="sm:col-span-6">
                      <label for="action_required" class="block text-sm font-semibold text-gray-800">
                        الإجراء المطلوب
                      </label>
                      <!-- v-if="mail_flag <= 2 || roles.includes('7')" -->
                      <textarea v-model="required_action" id="required_action" rows="3" class="
                            block
                            mt-2
                            w-full
                            text-sm
                    ...
                    <div class="
                      ...
                      <div class="sm:col-span-4">
                        <label for="department" class="block text-sm font-semibold text-gray-800">
                          الإدارات
                        </label>

                        <div class="relative">
                          <button @click="departmentselect = !departmentselect" @keyup.space.prevent id="department"
                            class="
                                overflow-hidden
                                text-right
                                block
                                ...
                                p-2
                              ">
                            <input v-model="departmentNameSelected" type="text" class="h-6 w-full" />
                          ...
                          <div v-if="departmentselect" class="
                                ...
                                rounded-b-md
                              ">
                            <button v-if="allDepartmentButton" class="
                                  block
                                  focus:outline-none
                                  w-full
                                  my-1
                            ...
                            <button class="
                                ...
                                departmentselect = !departmentselect;
                                                                " v-for="(department, index) in filterByTerm1" :key="department.id">
                              {{ department.departmentName }}
                            </button>
                          </div>
                        </div>
                      ...
                      <div class="sm:col-span-2">
                        <label for="measure" class="block text-sm font-semibold text-gray-800">
                          الإجراء
                        </label>
                      ...
                      <div class="sm:col-span-1 flex justify-end" v-if="measureNameSelected && departmentNameSelected">
                        <button v-if="add_button_consignees" @click="add_to_array_of_side_measure()" class="
                              mt-8
                              rounded-md
                              text-green-400
                              duration-200
                              ...
                              h-8
                            ">
                          <svg class="fill-current w-full h-full" version="1.1" id="Capa_1" x="0px" y="0px"
                    ...
                    <div class="sm:col-span-6">
                      <label for="consignees" class="block text-sm font-semibold text-gray-800">
                        المرسل إليهم
                      </label>
                      <div class="
                            mt-2
                        ...
                        <div v-for="consignee in consignees" :key="consignee.side" class="
                          ...
                          <button v-if="mail_flag <= 2 && consignees.length > 0" @click="
                            delete_side_measure(
                              consignee.departmentId,
                              consignee.departmentName
                            )
                          " class="mr-1 rounded-full">
                            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="times-circle" class="
                                  w-5
                                  h-5
                                  stroke-current
                                  text-red-400
                        ...
                        <div v-for="consignee in newactionSenders" :key="consignee.side" class="
                              border border-gary-200
                              rounded-md
                              text-sm
                              flex
                ...
                <section v-if="documentSection" class="col-span-2 bg-gray-100 rounded-md p-6">
                  <div class="flex justify-between items-center">
                    ...
                    <a v-if="roles.includes('t') && mailType == '1'" id="a1" @click="func()">
                      <label v-if="mailId" class="
                            ...
                            duration-300
                          ">
                        <svg class="w-5 h-5 ml-2" fill="currentColor" version="1.1" id="Capa_1"
                  ...
                  <div class="flex justify-between items-center mt-2">
                    <div v-if="image_of_doc" class="w-1/2 flex items-center">
                      <input type="text" v-model="doc_number_to_search" id="doc_number" class="
                            ml-2
                            block
                            w-16
                            rounded-md
                      ...
                      <button @click="search_the_doc()" class="
                              py-2
                              px-4
                              bg-white
                              rounded-lg
                    ...
                    <div class="w-1/2 flex justify-end">
                      <button v-if="roles.includes('6') && image_of_doc" @click="prepare_delete_all_documents()" class="
                          bg-red-500
                          hover:bg-red-400
                          px-4
                          py-2
                  ...
                  <div v-if="image_of_doc" class="h-72 w-full rounded-md mt-2 mb-10">
                    <!--  v-if="imagesToSend != '' || imagesToShow != ''" -->
                    <div class="mt-2 pt-2 pb-4 rounded-md relative">
                      <div v-if="!roles.includes('g')" class="
                            cursor-not-allowed
                            w-full
                            h-full
                      ...
                      <div class="">
                        <div class="relative h-64 w-full">
                          <img :src="image_of_doc" alt="image" class="w-full h-full rounded object-contain" />
                          ...
                          <div class="
                              ...
                              ">
                            <div class="">
                              <button @click="farst_documents()" class="
                                    bg-gray-500
                                    hover:bg-gray-400
                                    px-2
                                    py-2
                            ...
                            <div class="">
                              <button @click="show_current_image_for_bigger_screen()" type="button" class="
                                    bg-green-600
                                    hover:bg-green-500
                                    duration-500
                                    p-2
                              ...
                              <button v-if="roles.includes('6')" type="button" class="
                                    bg-red-600
                                    hover:bg-red-500
                                    duration-500
                                    p-2
                            ...
                            <div class="">
                              <button @click="last_documents()" class="
                                    bg-gray-500
                                    hover:bg-gray-400
                                    px-2
                                    py-2
                        ...
                        <div class="flex justify-between items-center pt-2 MB-2">
                          <div class="
                              ...
                              ">
                            <div class="w-8 h-8">
                              <button title="prev" v-if="doc_number > 1" @click="GetAllDocN('prev')" class="
                                    w-8
                                    h-8
                                    bg-gray-300
                                    rounded
                            ...
                            <div class="w-8 h-8">
                              <button v-if="doc_number < total_of_doc" title="next" @click="GetAllDocN('next')" class="
                                    w-8
                                    h-8
                                    bg-gray-300
                                    rounded
              ...
              <section v-if="mailType == '2' || mailType == '3'" class="
                    col-span-2
                    grid grid-cols-1
                    gap-y-6 gap-x-4
                    sm:grid-cols-6
                ...
                <div class="
                  ...
                  <fieldset class="sm:col-span-3">
                    <div class="flex items-center">
                      <legend class="block text-sm font-semibold text-gray-800 w-24">
                      ...
                      <div class="flex items-center w-32">
                        <input v-model="mail_forwarding" id="Branches" type="radio" name="forwarding" class="h-4 w-4"
                          value="1" @click="get_sectors(1)" />
                      ...
                      <div class="flex items-center w-32">
                        <input v-model="mail_forwarding" id="public_parties" type="radio" name="forwarding"
                          class="h-4 w-4" value="2" @click="get_sectors(2)" />
                        <label for="public_parties" class="mr-3 block text-gray-800">
                          جهات عامة
                        </label>
                      </div>

                      <div class="flex items-center w-32">
                        <input v-model="mail_forwarding" id="private_parties" type="radio" name="forwarding"
                          class="h-4 w-4" value="3" @click="get_sectors(3)" />
                        <label for="private_parties" class="mr-3 block text-gray-800">
                          جهات خاصة
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="
                    ...
                    <div class="sm:col-span-4">
                      ...
                      <div class="relative">
                        <button @click="sectorselect = !sectorselect" id="department" class="
                                overflow-hidden
                                text-right
                                block
                                mt-2
                        ...
                        <div v-if="sectorselect" class="
                          ...
                          <button class="
                                ...
                                sectorselect = !sectorselect;
                                                            " v-for="(sector, index) in sectors" :key="sector.id">
                            {{ sector.section_Name }}
                          </button>
                        </div>
                      </div>
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <div class="relative">
                        <button @click="sideselect = !sideselect" id="measure" class="
                                text-right
                                block
                                mt-2
                                w-full
                        ...
                        <div v-if="sideselect" class="
                          ...
                          <button class="
                                ...
                                sideselect = !sideselect;
                                                            " v-for="side in filterByTerm" :key="side.id">
                            {{ side.section_Name }}
                          </button>
                        </div>
                      </div>
                    ...
                    <div class="sm:col-span-1 flex justify-end" v-if="sectorNameSelected && sideNameSelected">
                      <button v-if="add_button_consignees" @click="add_sector_side_to_array()" class="
                              mt-8
                              rounded-md
                              text-green-400
                              duration-200
                ...
                <div v-if="mailType == '2'" class="sm:col-span-6">
                  ...
                  <textarea v-model="action_required_by_the_entity" id="action_required" rows="3" class="
                        block
                        mt-2
                        w-full
                        text-sm
                ...
                <div v-if="mailType == '3'" class="
                  ...
                  <fieldset class="sm:col-span-3">
                    <div class="flex items-center">
                      ...
                      <div class="flex items-center w-32">
                        <input v-model="ward_to" id="chief" type="radio" name="ward_to" class="h-4 w-4" value="1" />
                        <label for="chief" class="mr-3 block text-gray-800">
                          رئيس الهيئة
                        </label>
                      </div>
                      ...
                      <div class="flex items-center w-32">
                        <input v-model="ward_to" id="proxy" type="radio" name="ward_to" class="h-4 w-4" value="2" />
                        <label for="proxy" class="mr-3 block text-gray-800">
                          وكيل الهيئة
                        </label>
                      </div>
                      ...
                      <div class="flex items-center w-48">
                        <input v-model="ward_to" id="proxy" type="radio" name="ward_to" class="h-4 w-4" value="3" />
                        <label for="proxy" class="mr-3 block text-gray-800">
                          مدير إدارة أو مكتب
                        </label>
                      </div>
                  ...
                  <fieldset class="sm:col-span-3">
                    <div class="flex items-center">
                      ...
                      <div class="flex items-center w-32">
                        <input v-model="mail_ward_type" id="directly" type="radio" name="mail_ward_type" class="h-4 w-4"
                          value="1" />
                      ...
                      <div class="flex items-center w-32">
                        <input v-model="mail_ward_type" id="copy" type="radio" name="mail_ward_type" class="h-4 w-4"
                          value="2" />
                  ...
                  <div class="sm:col-span-2">
                    <label for="entity_mail_date" class="block text-sm font-semibold text-gray-800">
                      تاريخ رسالة الجهة
                    </label>
                    <input v-model="entity_mail_date" type="date" min="2000-01-01" max="2040-12-30" id="entity_mail_date"
                      class="
                          block
                          mt-2
                          w-full
                  ...
                  <div class="sm:col-span-2">
                    <label for="entity_reference_number" class="block text-sm font-semibold text-gray-800">
                      رقم إشارة الجهة
                    </label>
                    <input v-model="entity_reference_number" type="number" id="entity_reference_number" class="
                          block
                          mt-2
                          h-10
                          w-full
                  ...
                  <div class="sm:col-span-2">
                    <label for="procedure_type" class="block text-sm font-semibold text-gray-800">
                      نوع الإجراء
                    </label>
                    <select v-model="procedure_type" id="procedure_type" class="
                          block
                          mt-2
                          w-full
                          rounded-md
              ...
              <section>
                <div class="sm:col-span-6 flex items-center justify-end mt-10">
                  <div class="flex justify-end ml-6">
                    ...
                    <button v-if="summary && classification" @click="clear_page()" class="
                          flex
                          justify-center
                          items-center
                          py-2
                          ...
                          focus:outline-none
                        ">
                      <svg class="w-5 h-5 stroke-current ml-2 fill-current" enable-background="new 0 0 512 512"
                  ...
                  <div v-if="updataButton" class="flex justify-end ml-6">
                    <div v-if="roles.includes('w') && mailType == '1'" class="">
                      ...
                      " @click="updateMail" type="button" id="edit" class="
                            w-full
                            sm:w-auto sm:mr-3
                            flex
                            justify-center
                        ...
                        <svg class="
                          ...
                          xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 477.873 477.873"
                          style="enable-background: new 0 0 477.873 477.873" xml:space="preserve">
                          <g>
                            <g>
                              <path
                          ...
                          <g>
                            <g>
                              <path d="M458.742,19.142c-12.254-12.256-28.875-19.14-46.206-19.138c-17.341-0.05-33.979,6.846-46.199,19.149L141.534,243.937
                                            ...
                                            C443.754,73.631,440.467,81.575,434.603,87.419z"></path>
                            </g>
                          </g>
                        </svg>
                        تعديل
                  ...
                  <div v-if="deleteButton" class="flex justify-end ml-6">
                    <div v-if="roles.includes('3') && mailType == '1'" class="">
                      <button v-if="
                        ...
                        (consignees.length != 0 ||
                          newactionSenders.length != 0)
                      " @click="prepare_delete_mail()" type="button" id="edit" class="
                            w-full
                            sm:w-auto sm:mr-3
                            flex
                            justify-center
                    ...
                    <div v-if="roles.includes('4') && mailType == '3'" class="">
                      <button v-if="summary && classification" @click="prepare_delete_mail()" type="button" id="edit"
                        class="
                            w-full
                            sm:w-auto sm:mr-3
                            flex
                  ...
                  <div v-if="saveButton" class="flex justify-end">
                    <div v-if="mailType == '1'" class="">
                      ...
                      " class="
                            ...
                            focus:outline-none
                          " @click="saveMail()">
                        <svg class="w-4 h-4 stroke-current ml-2 fill-current" version="1.1" id="Capa_1"
                          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                          viewBox="0 0 512 512" style="enable-background: new 0 0 512 512" xml:space="preserve">
                          <g>
                            <g>
              ...
              <section class="bg-gray-100 rounded-md p-6 flex flex-wrap items-center">
                <button v-for="consignee in consignees" :key="consignee.side" @click="
    ...
    <div v-if="alert_prepare_delete_document" class="
          w-screen
          h-full
          flex
          justify-center
      ...
      <div class="
          ...
          ">
        <div class="">
          <svg class="w-20 h-20 stroke-current text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z">
            </path>
        ...
        <div class="mt-6">
          <button v-if="delete_all_documents" @click="deleteAllDocuments()" class="
                bg-red-600
                hover:bg-red-700 hover:shadow-lg
                duration-200
                rounded
          ...
          <button v-else @click="deleteDocument()" class="
                bg-red-600
                hover:bg-red-700 hover:shadow-lg
                duration-200
                rounded
          ...
          <button @click="alert_prepare_delete_document = false" class="
                bg-gray-400
                hover:bg-gray-700 hover:shadow-lg
                duration-200
                rounded
    ...
    <div v-if="alert_prepare_delete_mail" class="
          w-screen
          h-full
          flex
          justify-center
      ...
      <div class="
        ...
        <div class="mt-6">
          ...
          <button @click="alert_prepare_delete_mail = false" class="
                bg-gray-400
                hover:bg-gray-700 hover:shadow-lg
                duration-200
                rounded
    ...
    <div v-if="show_current_image_for_bigger_screen_model" class="w-screen h-full absolute inset-0 z-50 overflow-hidden">
      <div class="relative">
        <div v-if="image_to_print_n_model" id="printMe" class="bg-black bg-opacity-50 h-screen-100">
          <div v-for="image in image_to_print_n" :key="image.id" class="h-screen-100">
            <img :src="image.path" alt="" class="h-full w-full object-contain" />
          </div>
        </div>

        <div v-if="image_to_print_n_model" id="print_one_dec" class="bg-black bg-opacity-50 h-screen-100">
          <div class="h-screen-100">
            <img :src="image_of_doc" alt="" class="h-full w-full object-contain" />
          </div>
        </div>
        ...
        <div class="
          ...
          <div class="max-w-3xl mx-auto relative">
            ...
            <div class="h-screen-93 mt-4">
              <img :src="image_of_doc" alt="image" class="h-full w-full object-contain" />
            </div>
    ...
    <div v-if="show_current_reply_image_to_for_bigger_screen_model"
      ...
      <div class="relative">
        <div v-if="reply_image_to_print_n_model" id="print_reply_doc_n" class="bg-black bg-opacity-50 h-screen-100">
        ...
        <div class="
          ...
          <div class="max-w-3xl mx-auto relative">
            <div class="
              ...
              <button v-if="roles.includes('k')" @click="print_reply_image()" v-print="'#print_reply_doc_n'" class="
                    bg-blue-500
                    hover:bg-blue-400
                    px-4
                    py-2
    ...
    <div v-if="alert_state" class="
      ...
      <div class="
        ...
        <div v-if="alert_state_true_false" class="flex flex-col justify-center items-center">
          <div class="">
            <svg class="w-14 h-14 stroke-current stroke-2 text-green-600" fill="none" stroke="currentColor"
              viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div v-else class="flex flex-col justify-center items-center">
          <div class="">
            <svg class="w-14 h-14 stroke-current stroke-2 text-red-600" fill="none" stroke="currentColor"
              viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="{2}"
        ...
        <div class="mt-6">
          <button @click="alert_state = false" class="
                bg-blue-500
