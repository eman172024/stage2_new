          ...
          <main class="flex-1 relative focus:outline-none py-6">
            ...
            <div class="mt-6 space-y-6 ">
                ...
                <section class="bg-gray-50 rounded-md p-6">
                  <button v-for="consignee in consignees" :key="consignee.side" @click="GetReplyByDepartment(consignee.departmentId)" class="border border-blue-400 hover:bg-blue-400 hover:text-white duration-300 focus:outline-none rounded-md text-sm flex items-center p-2 m-0.5">
