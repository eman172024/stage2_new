            ...
            <div class="mt-6 space-y-6 ">
                ...
                <div class="grid grid-cols-7 gap-6">
                    ...
                    <section v-if="documentSection" class="col-span-2 bg-gray-50 rounded-md p-6">
                                ...
                                <div class="grid gap-6">
                                    <div v-for="(image, index) in imagesToSend" :key="index" class="relative h-60 w-full">
                                        ...
                                        <div class="flex justify-between items-center mt-4">
                                            ...
                                            <button class="w-12 bg-gray-300 rounded">
                                                >
                                            </button>
                        ...
                        <section class="mt-4 grid sm:grid-cols-2 gap-4">
                            <div v-if="!isThisMobile">
                                <label class="w-full flex justify-center items-center py-2 bg-white rounded-lg tracking-wide border border-green-600 cursor-pointer hover:text-white hover:bg-green-600 focus:outline-none duration-300">
                                    <svg
                                    class="w-5 h-5 ml-2"
                                    fill="currentColor"
                                    version="1.1"
                            ...
                            <div>
                                <label
                                    class="w-full flex justify-center items-center py-2 bg-white rounded-lg tracking-wide border border-green-600 cursor-pointer hover:text-white hover:bg-green-600 focus:outline-none duration-300"
                                >
                                    <svg
                                    class="w-5 h-5 ml-2"
                                    fill="currentColor"
                                    ...
                                    <span class="text-sm leading-normal">تحميل الصور</span>
                                    <input
                                    class="hidden"
                                    multiple
                                    type="file"
                            ...
                            <div v-if="isThisMobile" :class="isThisMobile ? '' : 'cursor-not-allowed'">
                                <label
                                    :class="
                                    isThisMobile
                                        ? 'border border-green-600 cursor-pointer hover:text-white hover:bg-green-600 focus:outline-none duration-300'
                                        : ' pointer-events-none'
                                    "
                                    class="w-full flex justify-center items-center py-2 bg-white rounded-lg tracking-wide"
                                >
                                    <svg
                                    class="w-5 h-5 ml-2"
                                    fill="currentColor"
