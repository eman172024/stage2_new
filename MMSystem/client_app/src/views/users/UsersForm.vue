...
<div class="h-screen bg-gray-100 overflow-hidden flex">
  ...
  <div class="bg-gray-200 h-screen w-full overflow-hidden" dir="rtl">
    ...
    <div v-if="isaddsuccess" class="w-96  z-50 p-4 bg-white rounded-lg absolute top-48 flex flex-col text-center items-center">
      ...
      <button class="bg-green-800 text-white h-10 w-32 mt-6 rounded-md" @click="isaddsuccess=false">موافق</button>
    </div>



    <div  v-if="iseditesuccess" class="w-96  z-50 p-4 bg-white rounded-lg absolute top-48 flex flex-col text-center items-center">
      <span>{{editesuccess}}</span>
    <button class="bg-green-800 text-white h-10 w-32 mt-6 rounded-md" @click="iseditesuccess=false">موافق</button>
