    ...
    >
      ...
      >
        <div
          ...
          "
        >
          <span class="col-span-2 mx-auto text-lg font-bold">اسم المستخدم</span>
        ...
        <div>
          ...
          >
            ...
            <span class="col-span-2 mx-auto"  v-else>{{ departmentNameSelected}}</span>


            <span class="col-span-1 mx-auto" v-if="user.state==true">مفعل</span>
            ...
            >
            <svg class="w-8 h-8 inline-block text-center" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
            </button>
            ...
            >
              <svg class="w-8 h-8 inline-block text-center" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"></path></svg>
            </button>
...
searchbyname(){
        ...
        this.$http.usersService.GetUsersByName(this.username)
       .then((res) => {
          console.log(res.data);
          this.users = res.data;
        })
